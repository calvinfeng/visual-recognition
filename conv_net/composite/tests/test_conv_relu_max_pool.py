from conv_net.composite.conv_relu_max_pool import ConvReLUMaxPool
from conv_net.gradient_check import *
import numpy as np
import unittest


class ConvReLUMaxPoolTest(unittest.TestCase):
    def test_backward_pass(self):
        ...
        self.layer = ConvReLUMaxPool(conv_param, pool_param)
